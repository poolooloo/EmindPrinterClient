#############################################################################
# Makefile for building: EmindPrint
...
=======
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -nocache 'QMAKE_CFLAGS_RELEASE=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'QMAKE_CFLAGS_DEBUG=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'QMAKE_CXXFLAGS_RELEASE=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'QMAKE_CXXFLAGS_DEBUG=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' QMAKE_LFLAGS_RELEASE=-Wl,-z,relro QMAKE_LFLAGS_DEBUG=-Wl,-z,relro QMAKE_STRIP=: PREFIX=/usr -o Makefile EmindPrint.pro
>>>>>>> cf66354b5e34046de2bb677dfe8de794c1a07bfe
#############################################################################
...
=======
CFLAGS        = -m64 -pipe -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -m64 -pipe -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
>>>>>>> cf66354b5e34046de2bb677dfe8de794c1a07bfe
...
<<<<<<< HEAD
DISTDIR = /home/wufeiyun/ProjectEx/EmindPrint/.tmp/EmindPrint1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
=======
